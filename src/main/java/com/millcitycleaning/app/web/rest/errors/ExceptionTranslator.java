package com.millcitycleaning.app.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.millcitycleaning.app.service.EmailAlreadyUsedException ||
            ex instanceof com.millcitycleaning.app.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.millcitycleaning.app.service.InvalidPasswordException
